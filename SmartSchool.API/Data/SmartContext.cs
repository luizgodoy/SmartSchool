        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Camila"),
                    new Professor(2, "Heloisa"),
                    new Professor(3, "Rosa"),
                    new Professor(4, "Rosa II"),
                    new Professor(5, "Samira"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Heitor", "Godoy", "33225555"),
                    new Aluno(2, "Gustavo", "Godoy", "3354288"),
                    new Aluno(3, "Sofia", "Rauli", "55668899"),
                    new Aluno(4, "Alice", "Abila", "6565659"),
                    new Aluno(5, "Antonia", "Ignacio", "565685415"),
                    new Aluno(6, "Pedro", "Russo", "456454545"),
                    new Aluno(7, "Artur", "Ciciri", "9874512")
                });
